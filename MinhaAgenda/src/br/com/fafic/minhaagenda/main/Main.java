...
public class Main {
    public static void main(String[] args) {
        ...
        // Crie um método que receba 2 parametros do tipo String e imprima-os concatenados 
        // *add +2 além do já feito*
        controller.adicionar("Claudia", "9 1122-1122");
        controller.adicionar("André", "9 2233-2233");
